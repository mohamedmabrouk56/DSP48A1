...
#set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports red_op_A]
#set_property -dict {PACKAGE_PIN T2 IOSTANDARD LVCMOS33} [get_ports red_op_B]
...
#set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports direction]
#set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports serial_in]
